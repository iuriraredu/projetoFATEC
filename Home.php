			...
			<nav>
				<div class="nav-wrapper red accent-4">
					...
					<a href="#" class="brand-logo center" style="text-shadow: 2px 2px 5px #c0c0c0">
						<i class="material-icons">event_note</i>SIC</a>
					<!-- Menu Mobile -->
					...
					<ul class="side-nav" id="menu-mobile">
						<li class="active"><a href="#"><i class="material-icons">announcement</i>Avisos</a></li>
						...
						<div class="col s12">
							<div class="card-panel red accent-4">
								<span class="card-title white-text">
									<h5>Painel de Avisos!</h5>
								</span>
								<br/>
								<span class="white-text">
									Aqui é o Painel de avisos!
								</span>
							</div>
						</div>
					</div>
